      ...
      $.each(arr, function(r, arrKey) {
        ...
        $("#waypointPopupList").append(
          '<li class="list-group-item" >' +
            ...
            "</div>" +
            "<div>" +
            '<a class="btn-primary btn-sm featureAdd" data-key="' +
            arrKey.key +
            '" data-name="' +
            obj.name +
            '"  data-type="' +
            ...
            '<a class="btn-primary btn-sm featureRemove" data-key="' +
            arrKey.key +
            '" data-name="' +
            obj.name +
            '" data-type="' +
            feature +
            '">Hide</a>&nbsp;' +
            '<a class="btn-primary btn-sm featureDelete" data-key="' +
            arrKey.key +
            '" data-name="' +
            obj.name +
            '" data-type="' +
      ...
      $("#waypointPopupList .featureAdd").on("click", function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            var layerSource = new ol.source.Vector({
              features: new ol.format.GeoJSON().readFeatures(data.feature, {
                dataProjection: "EPSG:4326",
                featureProjection: "EPSG:3857"
              })
            });
